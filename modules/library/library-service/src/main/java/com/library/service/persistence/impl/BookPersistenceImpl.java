...
import com.library.service.persistence.impl.constants.LibraryPersistenceConstants;
...
public class BookPersistenceImpl
	...
	@Override
	@Reference(
		target = LibraryPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = LibraryPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
